...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <?php echo $post_title; ?> Job Vacancy
            <small></small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Post</a></li>
            <li class="active"><a href="#"><?php echo $post_title; ?> Job Vacancy</a></li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box box-info">
                    <div class="box-body no-padding">
                        <!-- form start -->
                        <form role="form" id="form" method="post" enctype="multipart/form-data" action="<?php echo base_url() . ($mode == "add" ? 'content/add_career' : 'content/update_career/' . $this->input->get('id')); ?>">
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <?php if ($mode == "edit" and $post_data <> false and $post_data->file_name <> "") {
                                                ?>
                                                <img src="<?php echo $this->config->item('upload_path') . $post_data->file_name; ?>" width="150" height="200" />
                                                <?php
                                            } else {
                                                ?>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <?php
                                        if ($career_categories <> false) {
                                            foreach ($career_categories->result() as $row) {
                                                ?>
