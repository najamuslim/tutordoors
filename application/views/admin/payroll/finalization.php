	  ...
	  <div class="modal-dialog modal-sm" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	      	<label for="period">Period Tercatat: <?php echo $period.' ('.$period_desc.')'; ?></label>
	        Apakah anda yakin untuk finalisasi data ini ?
	      </div>
	      <div class="modal-footer">
	        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
	        <a href="<?php echo base_url('payroll/commit/'.$filter_param.'/'.$period) ?>" id="link-submit" class="btn btn-warning">Commit</a>
	      </div>
	    </div>
	  </div>
	</div>
