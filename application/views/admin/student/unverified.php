		...
		<div class="row">
			...
			<div class="col-xs-12">
          	...
          	<div class="box-header">
							<a href="<?php echo base_url('student/export/unverified')?>" class="btn btn-success"><i class="fa fa-download"></i> Download Data</a>
          	</div><!-- /.box-header -->
          	<div class="box-body">
							<table id="default-table" class="table table-bordered table-striped">
								...
								<tbody>
									<?php
						 			...
						 			?>
									<tr>
										<td width="60px"><input type="checkbox" name="check[]" value="<?php echo $student->user_id?>"></td>
										<td>
