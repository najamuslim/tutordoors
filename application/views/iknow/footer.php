                ...
                <div class="col-md-4">
                    <div class="widget widget-categories">
                        ...
                        <ul class="fa-ul">
                            ...
                            <li><a href="<?php echo $ig_link->parameter_value; ?>"><i class="fa-li fa fa-instagram" style="color:#fff"></i> <?php echo $ig_name->parameter_value; ?></a></li>
                        </ul>
                    </div>
                </div>
...
<!-- my functions -->
<script src="<?php echo IKNOW_DIR;?>js/functions.js?t=<?php echo time()?>"></script>
