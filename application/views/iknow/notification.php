                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <td><?php echo $this->lang->line('notification') ?></td>
                                    <td><?php echo $this->lang->line('time') ?></td>
                                </tr>
                            </thead>
                            <tbody>
                                <?php if($notifications<>false) {
                                    foreach($notifications->result() as $message){
                                        ?>
                                <tr>
                                    <td width="20px"><?php 
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="6">Total: <?php echo ($notifications<>false ? $notifications->num_rows() : '0').' '.ucwords($this->lang->line('notification')); ?></td>
                                    <!-- <td></td>
                                    <td>pesan</td> -->
                                </tr>
                            </tfoot>
