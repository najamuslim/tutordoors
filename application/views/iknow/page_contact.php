            ...
            <div class="col-md-5 summary-box">
              <div class="form-box">
                <div class="form-body">
                  ...
                  <?php 
                      ...
                      if($this->session->userdata('language')=="id") {
                      ?>
                      <h4>Jam kerja 8:00 - 16:00 WIB</h4>
              ...
              <div class="form-box">
                <div class="form-body">
                  ...
                  <div style="text-decoration:none; overflow:hidden; height:500px; width:500px; max-width:100%;"><div id="embedded-map-display" style="height:100%; width:100%;max-width:100%;"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.2710939902177!2d106.79657131471684!3d-6.227945095491751!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f148a36c4c2b%3A0x93d3a8c2f9b2e6!2sTutordoors!5e0!3m2!1sen!2sid!4v1571113372118!5m2!1sen!2sid" align="center" width="700" height="550" frameborder="0" style="border:0;" allowfullscreen=""></iframe></div><a class="google-code" href="https://www.hostingreviews.website/compare/hostgator-vs-godaddy" id="get-data-for-embed-map">hostgator vs godaddy</a><style>#embedded-map-display img{max-width:none!important;background:none!important;font-size: inherit;}</style></div><script src="https://www.hostingreviews.website/google-maps-authorization.js?id=8624d6fa-31d1-e346-4c08-c7abb02df7c1&c=google-code&u=1469614291" defer="defer" async="async"></script>
                </div>
                <div class="footer">
