                    ...
                    <div class="col-md-12">
                        ...
                        <div class="profile-box profile-view" style="margin-top: 0px;">
                            <div class="col-md-3">
                                ...
                                ?>
                                <div>
                                    <a href="#"><img class="img-circle" src="<?php echo UPLOAD_IMAGE_DIR . '/' . $photo_name; ?>" width="140" height="140" alt="Foto Profil" style="object-fit: cover;"></a>
                                </div>
                            </div>
                            <div class="col-md-9">
                                <div class="text">
                                  <!-- <p style="margin-bottom:10px">Hi,</p> -->
                                    <p style=" text-transform: capitalize;"><?php echo $this->session->userdata('fn') . ' ' . $this->session->userdata('ln'); ?></p>
                                    <p style="margin: ">ID: <?php echo $user_info->key_user_id; ?></p>
                                    <a href="<?php echo base_url('users/view_profile') ?>"><?php echo $this->lang->line('profile_full_info') ?>...</a>
                                </div>
                            </div>
                        </div>
                        <!--PROFILE IMAGE END-->
