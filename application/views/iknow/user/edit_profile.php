                ...
                <div class="modal-body">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="year_out" id="out-edit">
                        </div>
                        <div class="form-group">
                            <label><?php echo $this->lang->line('document_college_certificate') ?></label>
                            <input type="file" name="certificate">
                        </div>
                        <div class="form-group">
                            <label><?php echo $this->lang->line('document_transcript') ?></label>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9 col-md-push-3">
                ...
                <?php
                //for message after submitting data
                ...
                <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <?php if ($image_thumb <> "") { ?>
                                    <div class="thumb" style="text-align: center;" >
                                        <a href="#"><img class="img-circle" src="<?php echo UPLOAD_IMAGE_DIR . '/' . $image_thumb; ?>" alt="Foto Profil" width="100" height="100" style="object-fit: cover;"></a>
                                    </div>
                                    <?php
                                } else
                                    echo '<p>' . $this->lang->line('profile_picture_not_set') . '</p>';
                                ?>
                    ...
                    <?php if ($this->session->userdata('level') == "teacher") { ?>
                        <div class="col-md-12">
                            ...
                            <div class="profile-box editing">
                                <h2 style="margin-top:0px;" ><?php echo $this->lang->line('personal_data') ?></h2>
                                <div class="row">
                                    <form method="POST" action="<?php echo base_url('users/update_personal_info'); ?>" enctype="multipart/form-data">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('national_id_number') ?> <?php if ($this->session->userdata('level') == "teacher");?></label>
                                                <input type="text" class="form-control" name="ktp" value="<?php if ($user_info <> false) echo $user_info->national_card_number; ?>" maxlength="30" <?php if ($this->session->userdata('level') == "teacher") echo $user_info->national_card_number;?> >
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                if ($user_info <> false)
                                                    if ($user_info->national_card_attachment <> "") {
                                                        ...
                                                        ?>
                                                        <img src="<?php echo UPLOAD_IMAGE_DIR . '/' . $media_filename ?>" width="150" height="150" alt="" style="object-fit: contain; margin-top: 15px">
                                                    <?php } ?>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="religion" class="form-control">
                                                    <option value="Islam" <?php if ($user_info <> false) if ($user_info->religion == "Islam") echo "checked" ?>><?php echo $this->lang->line('religion_islam') ?></option>
                                                    <option value="Kristen" <?php if ($user_info <> false) if ($user_info->religion == "Kristen") echo "checked" ?>><?php echo $this->lang->line('religion_christian') ?></option>
                                                    <option value="Katholik" <?php if ($user_info <> false) if ($user_info->religion == "Katholik") echo "checked" ?>><?php echo $this->lang->line('religion_catholic') ?></option>
                                                    <option value="Hindu" <?php if ($user_info <> false) if ($user_info->religion == "Hindu") echo "checked" ?>><?php echo $this->lang->line('religion_hindu') ?></option>
                                                    <option value="Budha" <?php if ($user_info <> false) if ($user_info->religion == "Budha") echo "checked" ?>><?php echo $this->lang->line('religion_buddha') ?></option>
                                                    <option value="Khonghucu" <?php if ($user_info <> false) if ($user_info->religion == "Khonghucu") echo "checked" ?>><?php echo $this->lang->line('religion_khonghucu') ?></option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('address_on_national_card') ?></label>
                                                <input type="text" class="form-control" name="address-ktp" value="<?php if ($user_info <> false) echo $user_info->address_national_card; ?>" >
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="phone-1" value="<?php if ($user_info <> false) echo $user_info->phone_1; ?>" >
                                            </div>
                                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <!--EDIT GENERAL INFO START-->
                            <div class="profile-box editing">
                                <h2 style="margin-top:0px;" ><?php echo $this->lang->line('public_data') ?></h2>
                                <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="profile-box editing">
                                <h2 style="margin-top:0px;" ><?php echo $this->lang->line('education_latest') ?></h2>
                                ...
                                <form method="POST" action="<?php echo base_url('users/add_education_history') ?>" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class='form-group'>
                                                <label><?php echo $this->lang->line('college_year_in') ?><span class="label-required">*</span></label>
                                                <input type="text" class="form-control" id="input_year_in" name="year_in" maxlength="4" placeholder="Ex: 2011" required>
                                            </div>

                                            <input type="checkbox" name="is-graduated" onclick="enable_year_out()"> <?php echo $this->lang->line('is_graduated') ?>?

                                            <div class='form-group' id="div-year-out" style="display: none">
                                                <label><?php echo $this->lang->line('college_year_out') ?><span class="label-required">*</span></label>
                                                <input type="text" class="form-control" id="input_year_out" name="year_out" maxlength="4" placeholder="Ex: 2015" value="0" required>
                                            </div>

                                            <div class='form-group' id="div-certificate" style="display: none">
                                                <label><?php echo $this->lang->line('document_college_certificate') ?></label>
                                                <input type="file" name="certificate">
                                            </div>

                                            <div class='form-group' id="div-transcript" style="display: none">
                                                <label><?php echo $this->lang->line('document_transcript') ?></label>
                                                <input type="file" name="transcript">
                                            </div>
                                ...
                                <div class="row">
                                    <form method="POST" action="<?php echo base_url('users/update_student_personal_info'); ?>" enctype="multipart/form-data">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('name_last') ?><span class="label-required">*</span></label>
                                                <input type="text" class="form-control" name="last-name" value="<?php if ($user_info <> false) echo $user_info->last_name; ?>" required>
                                            </div>
                                            <label><?php echo $this->lang->line('sex') ?><span class="label-required">*</span></label>
                                            <div class="form-group">
                                                <div class="radio">
...
<script>
    function edit_edu(id) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#out-edit').val(data.year_out == "0" ? "" : data.year_out);
    ...
    function enable_year_out() {
        if ($('input[name="is-graduated"]').is(':checked')) {
            $('#div-year-out').show();
            var year_in = $('#input_year_in').val() == "" ? "" : parseInt($('#input_year_in').val()) + 4;
            $('#input_year_out').val(year_in);

            $('#div-certificate').show();
            $('#div-transcript').show();
        } else {
            $('#div-year-out').hide();
            $('#input_year_out').val("0");
