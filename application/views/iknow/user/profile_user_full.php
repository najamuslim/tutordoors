                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="profile-box editing">
                                            <?php if($image_thumb<>"") {?>
                                            <div class="thumb">
                                                <a href="#"><img class="img-circle" src="<?php echo UPLOAD_IMAGE_DIR.'/'.$image_thumb;?>"  width="140" height="140" alt="Foto Profil" style="object-fit: cover;"></a>
                                            </div>
                                            <?php } ?>
                                        </div> 
                                    ...
                                    <div class="col-md-4">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php if($user_info<>false) echo $user_info->religion ;?></td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <table>
                                            <tr>
                                                <td><strong><?php echo $this->lang->line('name_first') ?></strong></td>
                                                <td style="text-transform: capitalize;"><?php if($user_info<>false) echo $user_info->first_name;?></td>
                                            </tr>
                                            <tr>
                                                <td><strong><?php echo $this->lang->line('name_last') ?></strong></td>
                                                <td style="text-transform: capitalize;"><?php if($user_info<>false) echo $user_info->last_name;?></td>
                                            </tr>
                                            <tr>
                                                <td><strong><?php echo $this->lang->line('national_id_number') ?></strong></td>
                                                <td><?php if($user_info<>false) echo $user_info->national_card_number;?></td>
