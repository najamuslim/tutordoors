 ...
 *
 */
$config['APIUsername'] = $config['Sandbox'] ? 'td.test_api1.gmail.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? 'B39QE2F59GVBGPN8' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'A1KTTzKgOJauYFWByZ0-ztpEkEaAAAPqH9P-1pq6Ym-7PF1CDixsdkcL' : 'PRODUCTION_SIGNATURE_GOES_HERE';
