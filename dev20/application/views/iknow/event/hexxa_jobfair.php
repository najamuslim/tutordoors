...
<head>
<meta charset="utf-8">
<title>Event <?php echo $event_title ?> - Hexxa Academy</title>
  ...
  <div class="wrapper">
    ...
    <header>
      ...
      <div class="navigation-bar">
        <div class="container">
          <div class="logo">
            <a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>assets/images/logo-hexxa.png" alt="" width="176"></a>
          </div>
          <h4 style="margin-top: 90px;">Selamat Datang di Event <?php echo $event_title ?></h4>
          <h4>Silahkan mengisi form isian untuk menjadi calon tutor di Hexxa Academy</h4>
        </div>
      </div>
      <!--NAVIGATION END-->
    </header>
    ...
    <!-- <div class="page-heading" style="margin-top: 20px;"> 
      <div class="container">
        ...
        <br><br>
        <h2>Silahkan mengisi form isian untuk menjadi calon tutor di Hexxa Academy</h2>
      </div>
    </div> -->
    <!--BANNER END-->
    ...
    <div class="contant">
      <div class="container">
        <form method="POST" action="<?php echo base_url('event/jobfair_save/'.$event_id) ?>">
          ...
          <input type="hidden" name="company_id" value="HX">
          <div class="row">
            <div class="col-md-12">
              <div class="form-box">
                        ...
                        <tr>
                          <td>
                            <div class="form-group">
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="tk-calistung"> Calistung <br/> (Baca, Tulis, Hitung)
                                </label>
                              </div>
                            </div>
                          </td>
                          <td>
                            <div class="form-group">
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="sd-matematika"> Matematika
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="sd-ipa"> IPA
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="sd-ips"> IPS
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="sd-bahasa-indonesia"> Bahasa Indonesia
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="sd-bahasa-inggris"> Bahasa Inggris
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="sd-ppkn"> PPKn
                                </label>
                              </div>
                            </div>
                          </td>
                          <td>
                            <div class="form-group">
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="smp-matematika"> Matematika
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="smp-ipa"> IPA
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="smp-ips"> IPS
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="smp-bahasa-indonesia"> Bahasa Indonesia
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="smp-bahasa-inggris"> Bahasa Inggris
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="smp-ppkn"> PPKn
                                </label>
                              </div>
                            </div>
                          </td>
                          <td>
                            <div class="form-group">
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="sma-matematika"> Matematika
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="sma-biologi"> Biologi
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="sma-fisika"> Fisika
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="sma-kimia"> Kimia
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="sma-ekonomi"> Ekonomi
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="sma-akuntansi"> Akuntansi
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="sma-geografi"> Geografi
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="sma-bahasa-indonesia"> Bahasa Indonesia
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="sma-bahasa-inggris"> Bahasa Inggris
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="sma-ppkn"> PPKn
                                </label>
                              </div>
                            </div>
                          </td>
                          <td>
                            <div class="form-group">
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="umum-statistik"> Statistik
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="umum-kalkulus"> Kalkulus
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="umum-komputer"> Komputer
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="umum-art"> Art
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="umum-tari"> Tari
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="umum-mengaji-al-quran"> Mengaji / Baca Al Qur'an
                                </label>
                              </div>
                            </div>
                          </td>
                          <td>
                            <div class="form-group">
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="bahasa-english"> English
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="bahasa-bahasa-indonesia"> Bahasa Indonesia
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                              ...
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="bahasa-italy"> Italy
                                </label>
                              </div>
                            </div>
                          </td>
                          <td>
                            <div class="form-group">
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="musik-vokal"> Vokal
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="musik-gitar"> Gitar
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="musik-bass"> Bass
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="musik-drum"> Drum
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="musik-keyboard"> Keyboard
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="musik-piano"> Piano
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="musik-biola"> Biola
                                </label>
                              </div>
                              <div class="checkbox">
                                <label>
                                  <input type="checkbox" name="skill-mapel[]" value="musik-terompet"> Terompet
                                </label>
                              </div>
                            </div>
                          </td>
