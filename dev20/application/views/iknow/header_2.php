        ...
        <div class="col-md-6 col-sm-12 col-xs-12 col">
          <div class="field" style="margin-top: -8px;">
            <span class="fa-stack fa-lg">
              ...
              <i class="fa fa-building-o fa-stack-1x back-parent"></i>
            </span>
          </div>
          <div class="value"><?php echo $comp_address->parameter_value ?></div>
        </div>
        <div class="col-md-4 col-sm-8 col-xs-8 col">
          <div class="field" style="margin-top: -8px;">
            <span class="fa-stack fa-lg">
              <i class="fa fa-square fa-stack-2x back-white"></i>
          ...
          <div class="value"><?php echo $opt_phone->parameter_value .' / '.$opt_mobile->parameter_value ?></div>
        </div>
